...
# Model Server Security Group
resource "aws_security_group" "model_server" {
  name        = "${var.project_name}-${var.environment}-model-server-sg"
  description = "Security group for Model Server EC2"
  vpc_id      = aws_vpc.main.id
...
# Renderer Server Security Group
resource "aws_security_group" "renderer_server" {
  name        = "${var.project_name}-${var.environment}-renderer-server-sg"
  description = "Security group for Renderer Server EC2"
  vpc_id      = aws_vpc.main.id
